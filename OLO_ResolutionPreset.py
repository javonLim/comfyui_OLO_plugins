...
class OLO_ResolutionPreset:
            ...
            "required": {
                ...
                "preset_size": (
                    ["7680x4320 (8K横屏)", "5760x3240 (6K横屏)", "3840x2160 (4K横屏UHD)", "1920x1080 (横屏FHD)", "1280x720 (横屏HD)",
                     "960x544 (横屏)", "832x480 (Wan横屏)", 
                     "4320x7680 (8K竖屏)", "3240x5760 (6K竖屏)", "2160x3840 (4K竖屏UHD)", "1080x1920 (竖屏FHD)", "720x1280 (竖屏HD)", 
                     "544x960 (竖屏)", "480x832 (Wan竖屏)",

                     "1328x1328 (Qwen1K)", "1664x928 (Qwen横屏)", "928x1664 (Qwen竖屏)", 
    ...
    def get_size(self, use_custom_size, custom_width, custom_height, preset_size):
        ...
        size_map = {
            ...
            "544x960 (竖屏)": (544, 960),
            "480x832 (Wan竖屏)": (480, 832),

            "1328x1328 (Qwen1K)": (1328, 1328),
            "1664x928 (Qwen横屏)": (1664, 928),
            "928x1664 (Qwen竖屏)": (928, 1664),
...
# 节点注册
NODE_CLASS_MAPPINGS = {
    "OLO_ResolutionPreset": OLO_ResolutionPreset,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "OLO_ResolutionPreset": "OLO_分辨率预设",
}
